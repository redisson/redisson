...
public class CommandSyncService extends CommandAsyncService implements CommandExecutor {
  ...
  @Override
  public <T, R> R read(InetSocketAddress client, String key, RedisCommand<T> command,
      Object... params) {
  ...
  @Override
  public <T, R> R read(InetSocketAddress client, String key, Codec codec, RedisCommand<T> command,
      Object... params) {
  ...
  @Override
  public <T, R> R evalRead(String key, RedisCommand<T> evalCommandType, String script,
  ...
  @Override
  public <T, R> R evalWrite(String key, RedisCommand<T> evalCommandType, String script,
      List<Object> keys, Object... params) {
    return evalWrite(key, connectionManager.getCodec(), evalCommandType, script, keys, params);
  }

  @Override
  public <T, R> R evalWrite(String key, Codec codec, RedisCommand<T> evalCommandType,
  ...
  <R> R sync(boolean readOnlyMode, Codec codec, NodeSource source, SyncOperation<R> operation,
      int attempt) {
    ...
    try {
      ...
      try {
        ...
        return sync(readOnlyMode, codec, new NodeSource(e.getSlot(), e.getAddr(), Redirect.ASK),
            operation, attempt);
