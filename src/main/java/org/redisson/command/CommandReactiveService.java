...
public class CommandReactiveService extends CommandAsyncService implements CommandReactiveExecutor {
  ...
  @Override
  public <T, R> Publisher<R> evalWriteAllReactive(RedisCommand<T> command,
      SlotCallback<T, R> callback, String script, List<Object> keys, Object... params) {
  ...
  @Override
  public <T, R> Publisher<R> readReactive(InetSocketAddress client, String key, Codec codec,
  ...
  @Override
  public <T, R> Publisher<R> writeReactive(String key, Codec codec, RedisCommand<T> command,
      Object... params) {
  ...
  @Override
  public <T, R> Publisher<R> writeReactive(Integer slot, Codec codec, RedisCommand<T> command,
      Object... params) {
  ...
  @Override
  public <T, R> Publisher<R> readReactive(String key, Codec codec, RedisCommand<T> command,
      Object... params) {
  ...
  @Override
  public <T, R> Publisher<R> evalReadReactive(String key, Codec codec,
  ...
  @Override
  public <T, R> Publisher<R> evalReadReactive(InetSocketAddress client, String key, Codec codec,
      RedisCommand<T> evalCommandType, String script, List<Object> keys, Object... params) {
  ...
  @Override
  public <R, T> Publisher<R> writeAllReactive(RedisCommand<T> command, SlotCallback<T, R> callback,
      Object... params) {
