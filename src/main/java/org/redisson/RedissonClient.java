...
public interface RedissonClient {
   ...
   *
   * <p>
   * Uses <code>MGET</code> Redis command.
   *
   * @param keys
   * @return
   */
  ...
  /**
   * Returns blocking deque instance by name using provided codec for deque objects.
   *
   * @param name of deque
   * @param deque objects codec
   * @return
  ...
  /**
   * Returns {@code true} if this Redisson instance was started to be shutdown or was shutdown
   * {@link #isShutdown()} already.
   *
   * @return
   */
