...
/**
 * Configuration for an AWS ElastiCache replication group. A replication group is composed of a
 * single master endpoint and multiple read slaves.
 *
 * @author Steve Ungerer
 */
public class ElasticacheServersConfig extends
    BaseMasterSlaveServersConfig<ElasticacheServersConfig> {
