...
public interface RScriptReactive {
  ...
  <R> Publisher<R> evalSha(Mode mode, String shaDigest, ReturnType returnType, List<Object> keys,
      Object... values);
  ...
  <R> Publisher<R> eval(Mode mode, String luaScript, ReturnType returnType, List<Object> keys,
      Object... values);
