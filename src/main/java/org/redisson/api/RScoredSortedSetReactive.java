...
public interface RScoredSortedSetReactive<V> extends RExpirableReactive {
  ...
  Publisher<Integer> removeRangeByScore(double startScore, boolean startScoreInclusive,
  ...
  Publisher<Collection<V>> valueRange(double startScore, boolean startScoreInclusive,
      double endScore, boolean endScoreInclusive);

  Publisher<Collection<ScoredEntry<V>>> entryRange(double startScore, boolean startScoreInclusive,
      double endScore, boolean endScoreInclusive);
