...
public class RedisCommand<R> {
  ...
  public enum ValueType {
    OBJECT, OBJECTS, MAP_VALUE, MAP_KEY, MAP, BINARY
  }
  ...
  public RedisCommand(String name, int inParamIndex, List<ValueType> inParamType,
      ValueType outParamType) {
    this(name, null, null, null, inParamIndex);
  ...
  public RedisCommand(String name, Decoder<R> reponseDecoder, int inParamIndex,
      List<ValueType> inParamType, ValueType outParamType) {
  ...
  public RedisCommand(String name, MultiDecoder<R> replayMultiDecoder, int objectParamIndex,
      ValueType inParamType, ValueType outParamType) {
  ...
  public RedisCommand(String name, String subName, MultiDecoder<R> replayMultiDecoder,
      Decoder<R> reponseDecoder, int inParamIndex) {
    super();
    this.name = name;
