...
public class RedissonScript implements RScript {
  ...
  public Future<String> scriptLoadAsync(String luaScript) {
    return commandExecutor.writeAllAsync(RedisCommands.SCRIPT_LOAD,
        new SlotCallback<String, String>() {
  ...
  public <R> R eval(Mode mode, String luaScript, ReturnType returnType) {
    return eval(null, mode, commandExecutor.getConnectionManager().getCodec(), luaScript,
        returnType);
  }
  ...
  @Override
  public <R> R eval(Mode mode, String luaScript, ReturnType returnType, List<Object> keys,
      Object... values) {
    return eval(null, mode, commandExecutor.getConnectionManager().getCodec(), luaScript,
        returnType, keys, values);
  }
  ...
  public <R> R eval(String key, Mode mode, Codec codec, String luaScript, ReturnType returnType,
      List<Object> keys, Object... values) {
    return (R) commandExecutor
        .get(evalAsync(key, mode, codec, luaScript, returnType, keys, values));
  }

  @Override
  public <R> Future<R> evalAsync(Mode mode, String luaScript, ReturnType returnType,
      List<Object> keys, Object... values) {
    return evalAsync(null, mode, commandExecutor.getConnectionManager().getCodec(), luaScript,
        returnType, keys, values);
  }
  ...
  public <R> Future<R> evalAsync(String key, Mode mode, Codec codec, String luaScript,
      ReturnType returnType, List<Object> keys, Object... values) {
    if (mode == Mode.READ_ONLY) {
      return commandExecutor.evalReadAsync(key, codec, returnType.getCommand(), luaScript, keys,
          values);
    }
    return commandExecutor.evalWriteAsync(key, codec, returnType.getCommand(), luaScript, keys,
        values);
  }

  @Override
  public <R> R evalSha(Mode mode, String shaDigest, ReturnType returnType) {
    return evalSha(null, mode, commandExecutor.getConnectionManager().getCodec(), shaDigest,
        returnType);
  }
  ...
  public <R> R evalSha(String key, Mode mode, String shaDigest, ReturnType returnType) {
    return evalSha(key, mode, commandExecutor.getConnectionManager().getCodec(), shaDigest,
        returnType, Collections.emptyList());
  }
  ...
  @Override
  public <R> R evalSha(Mode mode, String shaDigest, ReturnType returnType, List<Object> keys,
      Object... values) {
    return evalSha(null, mode, commandExecutor.getConnectionManager().getCodec(), shaDigest,
        returnType, keys, values);
  }
  ...
  public <R> R evalSha(String key, Mode mode, Codec codec, String shaDigest, ReturnType returnType,
      List<Object> keys, Object... values) {
    return (R) commandExecutor.get(evalShaAsync(key, mode, codec, shaDigest, returnType, keys,
        values));
  }
  ...
  public <R> Future<R> evalShaAsync(Mode mode, String shaDigest, ReturnType returnType,
      List<Object> keys, Object... values) {
    return evalShaAsync(null, mode, commandExecutor.getConnectionManager().getCodec(), shaDigest,
        returnType, keys, values);
  }

  @Override
  public <R> Future<R> evalShaAsync(Mode mode, Codec codec, String shaDigest,
      ReturnType returnType, List<Object> keys, Object... values) {
    return evalShaAsync(null, mode, codec, shaDigest, returnType, keys, values);
  }

  public <R> Future<R> evalShaAsync(String key, Mode mode, Codec codec, String shaDigest,
      ReturnType returnType, List<Object> keys, Object... values) {
  ...
  public Future<List<Boolean>> scriptExistsAsync(final String... shaDigests) {
    return commandExecutor.writeAllAsync(RedisCommands.SCRIPT_EXISTS,
        new SlotCallback<List<Boolean>, List<Boolean>>() {
