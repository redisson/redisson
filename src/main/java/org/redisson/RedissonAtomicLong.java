...
public class RedissonAtomicLong extends RedissonExpirable implements RAtomicLong {
  ...
  public Future<Long> addAndGetAsync(long delta) {
    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE, RedisCommands.INCRBY,
        getName(), delta);
  }
  ...
  public Future<Long> getAndSetAsync(long newValue) {
    return commandExecutor.writeAsync(getName(), LongCodec.INSTANCE, RedisCommands.GETSET,
        getName(), newValue);
  }
  ...
  public Future<Long> incrementAndGetAsync() {
    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE, RedisCommands.INCR,
        getName());
  }
