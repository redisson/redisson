...
public class SingleServerConfig extends BaseConfig<SingleServerConfig> {
  ...
  /**
   * Should the server address be monitored for changes in DNS? Useful for AWS ElastiCache where the
   * client is pointed at the endpoint for a replication group which is a DNS alias to the current
   * master node.<br>
   ...
   *
   */
  public SingleServerConfig setSubscriptionConnectionMinimumIdleSize(
