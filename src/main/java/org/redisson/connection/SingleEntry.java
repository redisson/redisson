...
public class SingleEntry extends MasterSlaveEntry {
  ...
  public SingleEntry(Set<ClusterSlotRange> slotRanges, ConnectionManager connectionManager,
  ...
  public Future<Void> setupMasterEntry(String host, int port) {
    ...
    masterEntry =
        new ClientConnectionsEntry(masterClient, config.getMasterConnectionMinimumIdleSize(),
            config.getMasterConnectionPoolSize(), config.getSlaveConnectionMinimumIdleSize(),
