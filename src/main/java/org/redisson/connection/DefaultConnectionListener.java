...
public class DefaultConnectionListener implements ConnectionInitializer {
  ...
  public final <T extends RedisConnection> void onConnect(Promise<T> connectionFuture, T conn,
      NodeType nodeType, MasterSlaveServersConfig config) {
  ...
  protected void doConnect(MasterSlaveServersConfig config, NodeType nodeType,
