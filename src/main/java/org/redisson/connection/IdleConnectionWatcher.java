...
public class IdleConnectionWatcher {
  ...
  public static class Entry {
    ...
    public Entry(int minimumAmount, int maximumAmount,
        Collection<? extends RedisConnection> connections, AtomicInteger freeConnectionsCounter) {
      super();
  ...
  public IdleConnectionWatcher(final ConnectionManager manager,
      ...
      public void run() {
        ...
        for (Entry entry : entries) {
          ...
          for (final RedisConnection c : entry.connections) {
            ...
            if (timeInPool > config.getIdleConnectionTimeout() && validateAmount(entry)
