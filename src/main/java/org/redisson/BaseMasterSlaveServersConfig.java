...
public class BaseMasterSlaveServersConfig<T extends BaseMasterSlaveServersConfig<T>> extends
  ...
  /**
   * Redis 'slave' node minimum idle subscription (pub/sub) connection amount for <b>each</b> slave
   * node
   */
  ...
  BaseMasterSlaveServersConfig(T config) {
    ...
    setSlaveSubscriptionConnectionMinimumIdleSize(config
   ...
   *
   */
  public T setSlaveSubscriptionConnectionMinimumIdleSize(
      int slaveSubscriptionConnectionMinimumIdleSize) {
