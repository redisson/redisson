...
public interface RObjectAsync {
  ...
  /**
   * Rename current object key to <code>newName</code> in async mode
   *
   * @param newName
   * @return
   */
  ...
  /**
   * Rename current object key to <code>newName</code> in async mode only if new key is not exists
   *
   * @param newName
   * @return
   */
