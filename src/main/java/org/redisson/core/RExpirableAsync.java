...
public interface RExpirableAsync extends RObjectAsync {
  ...
  /**
   * Set a timeout for object in async mode. After the timeout has expired, the key will
  ...
  /**
   * Set an expire date for object in async mode. When expire date comes the key will automatically
   * be deleted.
   *
