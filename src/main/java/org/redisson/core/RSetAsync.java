...
public interface RSetAsync<V> extends RCollectionAsync<V> {
   ...
   * @return true if the element is moved, false if the element is not a member of this set or no
  ...
  /**
   * Union sets specified by name and write to current set. If current set already exists, it is
   * overwritten.
   *
   * @param names
   * @return
