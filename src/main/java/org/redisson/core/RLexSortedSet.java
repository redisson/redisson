...
public interface RLexSortedSet extends RLexSortedSetAsync, Set<String>, RExpirable {
  ...
  int removeRangeByLex(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive);
  ...
  Collection<String> lexRange(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive);
