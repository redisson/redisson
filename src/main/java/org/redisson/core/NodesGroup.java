...
public interface NodesGroup<N extends Node> {
  ...
  /**
   * Adds connect listener which will be triggered when Redisson has just been connected to or
  ...
  /**
   * All Redis nodes used by Redisson. This collection may change during master change, cluster
   * topology update and etc.
   *
   * @return
   */
