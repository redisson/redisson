...
/**
 * Guarantees multiple locks operation handling (lock, tryLock...) in atomic way without deadlocks.
 *
...
public class RedissonMultiLock implements Lock {
  ...
  /**
   * Creates instance with multiple {@link RLock} objects. Each RLock object could be created by own
   * Redisson instance.
   *
   * @param locks
   */
  ...
  private void lock(final Promise<Void> promise, final long waitTime, final long leaseTime,
      final TimeUnit unit) throws InterruptedException {
    final AtomicInteger tryLockRequestsAmount = new AtomicInteger();
    final Map<Future<Boolean>, RLock> tryLockFutures =
        new HashMap<Future<Boolean>, RLock>(locks.size());
