...
public interface RBlockingDequeAsync<V> extends RDequeAsync<V>, RBlockingQueueAsync<V> {
  ...
  /**
   * Retrieves and removes first available head element of <b>any</b> queue in async mode, waiting
   * up to the specified wait time if necessary for an element to become available in any of defined
   * queues <b>including</b> queue own.
   *
  ...
  /**
   * Retrieves and removes first available tail element of <b>any</b> queue in async mode, waiting
   * up to the specified wait time if necessary for an element to become available in any of defined
   * queues <b>including</b> queue own.
   *
   * @param timeout how long to wait before giving up, in units of {@code unit}
