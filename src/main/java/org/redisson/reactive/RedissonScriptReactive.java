...
public class RedissonScriptReactive implements RScriptReactive {
  ...
  public Publisher<String> scriptLoad(String luaScript) {
    return commandExecutor.writeAllReactive(RedisCommands.SCRIPT_LOAD,
  ...
  @Override
  public <R> Publisher<R> eval(RScript.Mode mode, Codec codec, String luaScript,
      RScript.ReturnType returnType, List<Object> keys, Object... values) {
    return eval(null, mode, codec, luaScript, returnType, keys, values);
  }

  public <R> Publisher<R> eval(String key, RScript.Mode mode, Codec codec, String luaScript,
      RScript.ReturnType returnType, List<Object> keys, Object... values) {
    if (mode == RScript.Mode.READ_ONLY) {
      return commandExecutor.evalReadReactive(key, codec, returnType.getCommand(), luaScript, keys,
          values);
    }
    return commandExecutor.evalWriteReactive(key, codec, returnType.getCommand(), luaScript, keys,
        values);
  }

  @Override
  public <R> Publisher<R> evalSha(RScript.Mode mode, String shaDigest,
      RScript.ReturnType returnType, List<Object> keys, Object... values) {
  ...
  @Override
  public <R> Publisher<R> evalSha(RScript.Mode mode, Codec codec, String shaDigest,
      RScript.ReturnType returnType, List<Object> keys, Object... values) {
    return evalSha(null, mode, codec, shaDigest, returnType, keys, values);
  }

  public <R> Publisher<R> evalSha(String key, RScript.Mode mode, Codec codec, String shaDigest,
      RScript.ReturnType returnType, List<Object> keys, Object... values) {
  ...
  public Publisher<List<Boolean>> scriptExists(final String... shaDigests) {
    return commandExecutor.writeAllReactive(RedisCommands.SCRIPT_EXISTS,
