...
public class RedissonBucketReactive<V> extends RedissonExpirableReactive implements
    RBucketReactive<V> {
  ...
  public Publisher<Void> set(V value, long timeToLive, TimeUnit timeUnit) {
    return commandExecutor.writeReactive(getName(), codec, RedisCommands.SETEX, getName(),
