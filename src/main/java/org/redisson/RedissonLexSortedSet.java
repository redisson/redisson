...
public class RedissonLexSortedSet extends RedissonScoredSortedSet<String> implements RLexSortedSet {
  ...
  @Override
  public int removeRangeByLex(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive) {
  ...
  public Future<Integer> removeRangeHeadByLexAsync(String toElement, boolean toInclusive) {
    ...
    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE,
        RedisCommands.ZREMRANGEBYLEX, getName(), "-", toValue);
  }
  ...
  public Future<Integer> removeRangeTailByLexAsync(String fromElement, boolean fromInclusive) {
    ...
    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE,
        RedisCommands.ZREMRANGEBYLEX, getName(), fromValue, "+");
  }

  @Override
  public Future<Integer> removeRangeByLexAsync(String fromElement, boolean fromInclusive,
      String toElement, boolean toInclusive) {
    String fromValue = value(fromElement, fromInclusive);
    String toValue = value(toElement, toInclusive);

    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE,
        RedisCommands.ZREMRANGEBYLEX, getName(), fromValue, toValue);
  }

  @Override
  public Collection<String> lexRange(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive) {
  ...
  public Future<Collection<String>> lexRangeHeadAsync(String toElement, boolean toInclusive) {
    String toValue = value(toElement, toInclusive);
    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZRANGEBYLEX,
        getName(), "-", toValue);
  }
  ...
  @Override
  public Future<Collection<String>> lexRangeAsync(String fromElement, boolean fromInclusive,
      String toElement, boolean toInclusive) {
    String fromValue = value(fromElement, fromInclusive);
    String toValue = value(toElement, toInclusive);

    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZRANGEBYLEX,
        getName(), fromValue, toValue);
  }
  ...
  @Override
  public Collection<String> lexRangeHead(String toElement, boolean toInclusive, int offset,
      int count) {
  ...
  public Future<Collection<String>> lexRangeHeadAsync(String toElement, boolean toInclusive,
    ...
    String toValue = value(toElement, toInclusive);
    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZRANGEBYLEX,
        getName(), "-", toValue, "LIMIT", offset, count);
  }

  @Override
  public Collection<String> lexRangeTail(String fromElement, boolean fromInclusive, int offset,
      int count) {
  ...
  public Future<Collection<String>> lexRangeTailAsync(String fromElement, boolean fromInclusive,
    ...
    String fromValue = value(fromElement, fromInclusive);
    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZRANGEBYLEX,
        getName(), fromValue, "+", "LIMIT", offset, count);
  }
  ...
  public Future<Collection<String>> lexRangeAsync(String fromElement, boolean fromInclusive,
    ...
    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZRANGEBYLEX,
        getName(), fromValue, toValue, "LIMIT", offset, count);
  }
  ...
  public Future<Integer> lexCountTailAsync(String fromElement, boolean fromInclusive) {
    ...
    return commandExecutor.readAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZLEXCOUNT,
        getName(), fromValue, "+");
  }
  ...
  @Override
  public int lexCount(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive) {
    return get(lexCountAsync(fromElement, fromInclusive, toElement, toInclusive));
  }

  @Override
  public Future<Integer> lexCountAsync(String fromElement, boolean fromInclusive, String toElement,
      boolean toInclusive) {
    String fromValue = value(fromElement, fromInclusive);
    String toValue = value(toElement, toInclusive);
  ...
  public Future<Boolean> addAsync(String e) {
    return commandExecutor.writeAsync(getName(), StringCodec.INSTANCE, RedisCommands.ZADD_BOOL_RAW,
        getName(), 0, e);
  }
