...
public class RedissonScriptReactiveTest extends BaseReactiveTest {
  ...
  public void testEval() {
    ...
    List<Object> res =
        sync(script.<List<Object>>eval(RScript.Mode.READ_ONLY,
            "return {1,2,3.3333,'\"foo\"',nil,'bar'}", RScript.ReturnType.MULTI,
  ...
  public void testScriptFlush() {
    ...
    Assert.assertEquals("282297a0228f48cd3fc6a55de6316f31422f5d17", r);
    String r1 =
        sync(redisson.getScript().<String>evalSha(RScript.Mode.READ_ONLY,
    ...
    try {
      sync(redisson.getScript().evalSha(RScript.Mode.READ_ONLY,
          "282297a0228f48cd3fc6a55de6316f31422f5d17", RScript.ReturnType.VALUE,
          Collections.emptyList()));
    } catch (Exception e) {
  ...
  public void testEvalSha() {
    ...
    sync(redisson.getBucket("foo").set("bar"));
    String r1 =
        sync(s.<String>evalSha(RScript.Mode.READ_ONLY, "282297a0228f48cd3fc6a55de6316f31422f5d17",
