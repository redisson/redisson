...
public class RedissonMapCacheReactiveTest extends BaseReactiveTest {
  ...
  public void testGetAll() throws InterruptedException {
    ...
    Map<Integer, Integer> filteredAgain =
        sync(map.getAll(new HashSet<Integer>(Arrays.asList(2, 3, 5))));
  ...
  public void testGetAllWithStringKeys() {
    ...
    Map<String, Integer> filtered =
        sync(map.getAll(new HashSet<String>(Arrays.asList("B", "C", "E"))));
  ...
  public void testPutAll() {
    ...
    MatcherAssert.assertThat(toIterable(map.keyIterator()),
        Matchers.containsInAnyOrder(1, 2, 3, 4, 5, 6));
  }

  @Test
  public void testContainsValue() throws InterruptedException {
    RMapCacheReactive<SimpleKey, SimpleValue> map =
        redisson.getMapCache("simple31", new MsgPackJacksonCodec());
  ...
  public void testScheduler() throws InterruptedException {
    RMapCacheReactive<SimpleKey, SimpleValue> map =
        redisson.getMapCache("simple", new MsgPackJacksonCodec());
  ...
  public void testPutGet() throws InterruptedException {
    RMapCacheReactive<SimpleKey, SimpleValue> map =
        redisson.getMapCache("simple01", new MsgPackJacksonCodec());
    Assert.assertNull(sync(map.get(new SimpleKey("33"))));
  ...
  public void testPutIfAbsent() throws Exception {
    ...
    Assert.assertEquals(value,
        sync(map.putIfAbsent(key, new SimpleValue("3"), 1, TimeUnit.SECONDS)));
