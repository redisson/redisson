...
public class RedissonLexSortedSetReactiveTest extends BaseReactiveTest {
  ...
  public void testLexRangeTail() {
    ...
    MatcherAssert.assertThat(sync(set.lexRangeTail("c", false)),
        Matchers.contains("d", "e", "f", "g"));
    MatcherAssert.assertThat(sync(set.lexRangeTail("c", true)),
        Matchers.contains("c", "d", "e", "f", "g"));
  }
  ...
  public void testLexRange() {
    ...
    MatcherAssert.assertThat(sync(set.lexRange("aaa", true, "g", false)),
        Matchers.contains("b", "c", "d", "e", "f"));
  }
