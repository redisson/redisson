...
```groovy
     // for Hibernate v4.x
     compile 'org.redisson:redisson-hibernate-4:3.35.0'
     // for Hibernate v5.0.x - v5.1.x
     compile 'org.redisson:redisson-hibernate-5:3.35.0'
     // for Hibernate v5.2.x
     compile 'org.redisson:redisson-hibernate-52:3.35.0'
     // for Hibernate v5.3.3+ - v5.6.x
     compile 'org.redisson:redisson-hibernate-53:3.35.0'
     // for Hibernate v6.0.2+ - v6.x.x
     compile 'org.redisson:redisson-hibernate-6:3.35.0'
```
