...
`org.redisson.codec.AvroJacksonCodec`| [Avro](http://avro.apache.org/) binary json codec based on Jackson lib  
`org.redisson.codec.AvroJackson3Codec`| [Avro](http://avro.apache.org/) binary json codec based on Jackson 3 lib  
`org.redisson.codec.SmileJacksonCodec`| [Smile](http://wiki.fasterxml.com/SmileFormatSpec) binary json codec based on Jackson lib  
`org.redisson.codec.SmileJackson3Codec`| [Smile](http://wiki.fasterxml.com/SmileFormatSpec) binary json codec based on Jackson 3 lib  
`org.redisson.codec.CborJacksonCodec`| [CBOR](http://cbor.io/) binary json codec based on Jackson lib  
`org.redisson.codec.CborJackson3Codec`| [CBOR](http://cbor.io/) binary json codec based on Jackson 3 lib  
`org.redisson.codec.MsgPackJacksonCodec`| [MsgPack](http://msgpack.org/) binary json codec  
`org.redisson.codec.IonJacksonCodec`| [Amazon Ion](https://amzn.github.io/ion-docs/) codec based on Jackson lib  
`org.redisson.codec.IonJackson3Codec`| [Amazon Ion](https://amzn.github.io/ion-docs/) codec based on Jackson 3 lib  
...
`org.redisson.codec.LZ4Codec`| [LZ4](https://github.com/yawkat/lz4-java) compression codec<br/> Uses `Kryo5Codec` for serialization by default  
