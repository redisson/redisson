...
#### Gradle
    compile 'org.redisson:redisson:3.19.2'  

#### SBT
    libraryDependencies += "org.redisson" % "redisson" % "3.19.2"
...
[Redisson 3.19.2](https://repository.sonatype.org/service/local/artifact/maven/redirect?r=central-proxy&g=org.redisson&a=redisson&v=3.19.2&e=jar),
[Redisson node 3.19.2](https://repository.sonatype.org/service/local/artifact/maven/redirect?r=central-proxy&g=org.redisson&a=redisson-all&v=3.19.2&e=jar)  
