...
#### Gradle
    compile 'org.redisson:redisson:3.16.8'  

#### SBT
    libraryDependencies += "org.redisson" % "redisson" % "3.16.8"
...
[Redisson 3.16.8](https://repository.sonatype.org/service/local/artifact/maven/redirect?r=central-proxy&g=org.redisson&a=redisson&v=3.16.8&e=jar),
[Redisson node 3.16.8](https://repository.sonatype.org/service/local/artifact/maven/redirect?r=central-proxy&g=org.redisson&a=redisson-all&v=3.16.8&e=jar)  
