...
```groovy
// for Quarkus v3.x.x
compile 'org.redisson:redisson-quarkus-30-cache:3.36.0'
```
...
```groovy
// for Quarkus v1.6.x - v1.13.x
compile 'org.redisson:redisson-quarkus-16:3.36.0'
// for Quarkus v2.x.x
compile 'org.redisson:redisson-quarkus-20:3.36.0'
// for Quarkus v3.x.x
compile 'org.redisson:redisson-quarkus-30:3.36.0'
```
