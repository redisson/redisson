 ...
 */
public interface RTimeSeriesNativesReactive {
     ...
     */
    Mono<Map<String, List<Long>>> addAll(Map<String, Map<Long, Double>> samples);
     ...
     */
    Mono<Map<String, TSSeriesSample>> getAll(TSMultiGetArgs args);
     ...
     */
    Mono<Map<String, TSSeriesSamples>> range(TSMultiRangeArgs args);
     ...
     * @return one entry per matching series, or per group when GROUPBY is used
     */
    Mono<Map<String, TSSeriesSamples>> rangeReversed(TSMultiRangeArgs args);
     ...
     */
    Mono<List<TSSample>> groupedRange(TSGroupedRangeArgs args);
     ...
     */
    Mono<List<TSSample>> groupedRangeReversed(TSGroupedRangeArgs args);
     ...
     */
    Mono<Set<String>> queryIndex(String... filters);
     ...
     */
    Mono<Set<String>> labelNames(String... filters);
     ...
     */
    Mono<Set<String>> labelValues(String label, String... filters);
