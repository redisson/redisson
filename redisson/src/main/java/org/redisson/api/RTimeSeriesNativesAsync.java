 ...
 */
public interface RTimeSeriesNativesAsync {
     ...
     */
    RFuture<Map<String, List<Long>>> addAllAsync(Map<String, Map<Long, Double>> samples);
     ...
     */
    RFuture<Map<String, TSSeriesSample>> getAllAsync(TSMultiGetArgs args);
     ...
     */
    RFuture<Map<String, TSSeriesSamples>> rangeAsync(TSMultiRangeArgs args);
     ...
     * @return one entry per matching series, or per group when GROUPBY is used
     */
    RFuture<Map<String, TSSeriesSamples>> rangeReversedAsync(TSMultiRangeArgs args);
     ...
     */
    RFuture<List<TSSample>> groupedRangeAsync(TSGroupedRangeArgs args);
     ...
     */
    RFuture<List<TSSample>> groupedRangeReversedAsync(TSGroupedRangeArgs args);
     ...
     */
    RFuture<Set<String>> queryIndexAsync(String... filters);
     ...
     */
    RFuture<Set<String>> labelNamesAsync(String... filters);
     ...
     */
    RFuture<Set<String>> labelValuesAsync(String label, String... filters);
