 ...
 *
 */
public final class ConsumerStatisticsImpl implements ConsumerStatistics {
    ...
    public ConsumerStatisticsImpl(String name, long unacknowledgedMessages, long acknowledgedMessages, long negativelyAcknowledgedMessages) {
        this.name = name;
