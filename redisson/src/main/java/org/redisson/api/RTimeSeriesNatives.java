 ...
 */
public interface RTimeSeriesNatives extends RTimeSeriesNativesAsync {
     ...
     */
    Map<String, List<Long>> addAll(Map<String, Map<Long, Double>> samples);
     ...
     */
    Map<String, TSSeriesSample> getAll(TSMultiGetArgs args);
     ...
     */
    Map<String, TSSeriesSamples> range(TSMultiRangeArgs args);
     ...
     * @return one entry per matching series, or per group when GROUPBY is used
     */
    Map<String, TSSeriesSamples> rangeReversed(TSMultiRangeArgs args);
     ...
     */
    List<TSSample> groupedRange(TSGroupedRangeArgs args);
     ...
     */
    List<TSSample> groupedRangeReversed(TSGroupedRangeArgs args);
     ...
     */
    Set<String> queryIndex(String... filters);
     ...
     */
    Set<String> labelNames(String... filters);
     ...
     */
    Set<String> labelValues(String label, String... filters);
