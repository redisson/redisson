...
public interface RTimeSeriesRx<V, L> extends RExpirableRx {
    ...
    /**
     * Use {@link #add(TimeSeriesAddArgs)} instead
     *
     ...
     * there; {@link #addIfAbsent(TimeSeriesAddArgs)} and {@link #addOrReplace(TimeSeriesAddArgs)}
     * are the ones that decide what happens to a duplicate.
     * <p>
     ...
     */
    Single<Boolean> add(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     */
    Single<Boolean> addIfAbsent(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     */
    Single<Boolean> addOrReplace(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     */
    Single<Collection<V>> getAll(long timestamp);
     ...
     */
    Single<Collection<TimeSeriesEntry<V, L>>> getAllEntries(long timestamp);
     ...
     */
    Single<Integer> removeAll(long timestamp);
     ...
     * @return collection of objects
     */
    Single<Collection<V>> getAndRemoveAll(long timestamp);
     ...
     * @return collection of time series entries
     */
    Single<Collection<TimeSeriesEntry<V, L>>> getAndRemoveAllEntries(long timestamp);
     ...
     * @return elements collection
     */
    Single<Collection<V>> rangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return elements collection
     */
    Single<Collection<V>> rangeByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return elements collection
     */
    Single<Collection<V>> rangeReversedByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return elements collection
     */
    Single<Collection<V>> rangeReversedByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     */
    Single<Collection<TimeSeriesEntry<V, L>>> entryRangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return entries collection
     */
    Single<Collection<TimeSeriesEntry<V, L>>> entryRangeByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return entries collection
     */
    Single<Collection<TimeSeriesEntry<V, L>>> entryRangeReversedByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return entries collection
     */
    Single<Collection<TimeSeriesEntry<V, L>>> entryRangeReversedByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return number of removed elements
     */
    Single<Integer> removeRangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return labels set
     */
    Single<Set<L>> labels(long startTimestamp, long endTimestamp);
     ...
     */
    Single<Collection<TimeSeriesBucket>> aggregate(TimeSeriesAggregationArgs<? super L> args);
     ...
     * @return entries collection
     */
    Single<Collection<TimeSeriesEntry<V, L>>> readTail(TimeSeriesReadArgs<? super L> args);
     ...
     */
    Single<Boolean> addIfLess(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     * @return <code>true</code> if the value was stored
     */
    Single<Boolean> addIfGreater(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     */
    Single<Boolean> addAndSum(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     */
    Single<Double> addAndGet(TimeSeriesAddArgs<V, ? super L> increment);
