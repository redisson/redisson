...
/**
 * A Top-K is a probabilistic data structure that keeps track of the
 * {@code k} most frequent items in a stream using the HeavyKeeper algorithm,
 * using a fixed amount of memory regardless of the number of distinct items seen.
 * <p>
 * Covers {@code TOPK.*} commands of the Redis Bloom module.
 *
