...
public interface RTimeSeries<V, L> extends RExpirable, Iterable<V>, RTimeSeriesAsync<V, L>, RDestroyable {
     ...
     */
    boolean add(TimeSeriesAddArgs<V, ? super L> entry);
     ...
     * @return elements collection
     */
    Collection<V> rangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return elements collection
     */
    Collection<V> rangeByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return elements collection
     */
    Collection<V> rangeReversedByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return elements collection
     */
    Collection<V> rangeReversedByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     */
    Collection<TimeSeriesEntry<V, L>> entryRangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return entries collection
     */
    Collection<TimeSeriesEntry<V, L>> entryRangeByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return entries collection
     */
    Collection<TimeSeriesEntry<V, L>> entryRangeReversedByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return entries collection
     */
    Collection<TimeSeriesEntry<V, L>> entryRangeReversedByLabel(long startTimestamp, long endTimestamp, L label, int limit);
     ...
     * @return number of removed elements
     */
    int removeRangeByLabel(long startTimestamp, long endTimestamp, L label);
     ...
     * @return entries collection
     */
    Collection<TimeSeriesEntry<V, L>> readTail(TimeSeriesReadArgs<? super L> args);
