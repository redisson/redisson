...
/**
 * Interface for mass operations with Map objects.
 * <p>
 * Map objects sharing the same field names are written with a single declaration
 * of those field names, which reduces the amount of transferred data and allows Redis
 * to keep one copy of the field names for all such objects.
 *
