...
/**
 * RxJava3 interface for count-min sketch ({@code CMS.*} commands).
 *
 ...
 *
 */
public interface RCountMinRx<V> extends RExpirableRx {
     ...
     * @return void
     */
    Completable init(CountMinInitArgs args);
     ...
     * @return new count of the element
     */
    Single<Long> add(V element, long increment);
     ...
     */
    Single<Map<V, Long>> add(Map<V, Long> elements);
     ...
     */
    Single<Map<V, Long>> count(Collection<V> elements);
     ...
     * @return void
     */
    Completable mergeWith(CountMinMergeArgs args);
