        ...
        return commandExecutor.evalWriteAsync(getRawName(), LongCodec.INSTANCE, command,
              ...
              + "if currentValue ~= false then "
                     ...
                     + "for i, v in ipairs(expiredValues) do "
                          + "local combine, permits = struct.unpack('Bc0I', v);"
                     ...
                     + "else "
                         + "local combine = ARGV[3] .. ARGV[2];"
                         + "redis.call('zadd', permitsName, ARGV[2], struct.pack('Bc0I', string.len(combine), combine, ARGV[1])); "
