...
import org.redisson.api.RMapsRx;
...
public class RedissonMapsRxTest extends BaseRxTest {

    @Test
    public void testSet() {
        RMapsRx<String, String> maps = redisson.getMaps(StringCodec.INSTANCE);
    ...
    public void testImport() {
        RMapsImportRx<String, String> mapsImport = createImport("name", "email", "age");
    ...
    public void testImportComposedIntoStream() {
        RMapsImportRx<String, String> mapsImport =
                redisson.<String, String>getMaps(StringCodec.INSTANCE)
                        .createImport(MapsImportArgs.<String>fields("name", "age").batchSize(10));

        Flowable.range(0, 100)
                .concatMapCompletable(i -> mapsImport.add("user:" + i, "user" + i, String.valueOf(i)))
                .andThen(mapsImport.flush())
                .blockingAwait();
    ...
    public void testAddIsAppliedOnSubscription() {
        RMapsImportRx<String, String> mapsImport = createImport("name");
    ...
    private RMapsImportRx<String, String> createImport(String... fields) {
    ...
    private Map<String, String> readMap(String name) {
        RMapRx<String, String> map = redisson.getMap(name, StringCodec.INSTANCE);
