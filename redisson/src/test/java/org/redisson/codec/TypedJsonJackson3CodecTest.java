...
public class TypedJsonJackson3CodecTest extends RedisDockerTest {
    ...
    private final TypedJsonJackson3Codec valueCodec = new TypedJsonJackson3Codec(new TypeReference<Object>() {});
    
    private final TypedJsonJackson3Codec mapCodec = new TypedJsonJackson3Codec(null, new TypeReference<Map<String, List<String>>>() {});

    private final TypedJsonJackson3Codec stringCodec = new TypedJsonJackson3Codec(null, String.class);
    ...
    @Test
    public void testMap() {
        RMap<String, byte[]> map = redisson.getMap("anyMap", new TypedJsonJackson3Codec(String.class, byte[].class));
    ...
    public void testBucket() {
        RBucket<String> bucket = redisson.getBucket("anyMap", new TypedJsonJackson3Codec(String.class));
