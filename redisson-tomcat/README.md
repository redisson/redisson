...
1. __For JDK 1.8+__  
      ...
      for Tomcat 8.x  
      [redisson-tomcat-8-3.5.1.jar](https://repository.sonatype.org/service/local/artifact/maven/redirect?r=central-proxy&g=org.redisson&a=redisson-tomcat-8&v=3.5.1&e=jar)
